...
static const char *fonts[]          = { "Roboto Mono:style=Medium:size=10",
					"icomoon\-feather:style=Regular:size=20;4" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#FFFFFF";
static const char col_gray2[]       = "#050505";
static const char col_gray3[]       = "#000000";
static const char col_gray4[]       = "#03020E";
static const char col_cyan[]        = "#252525";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#d0d0dc", col_gray4, col_gray2 },
	[SchemeSel]  = { "#d0d0dc", col_gray4,  col_cyan  },
};
...
static const char *output_to_hdmi[] = { "xrandr", "--output", "eDP-1", "--off" ,"--output" ,"HDMI-1", "--auto", NULL };
static const char *output_to_screen[] = { "xrandr", "--output", "eDP-1", "--auto" ,"--output" ,"HDMI-1", "--off", NULL };
